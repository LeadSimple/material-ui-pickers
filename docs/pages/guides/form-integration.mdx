...
Here is an example of how to integrate @leadsimple/material-ui-pickers with Formik

<Example source={FormikExample} />

#### Redux Form Integration

@leadsimple/material-ui-pickers can also be integrated with Redux Form
