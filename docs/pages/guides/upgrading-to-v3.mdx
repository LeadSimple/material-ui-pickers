...
Version `v3` for @leadsimple/material-ui-pickers is coming with a whole bunch of breaking changes. This is a guide of how-to update :)
...
Please also note, that **v3** of `@leadsimple/material-ui-pickers` relies on **v4** of `@material-ui/core`

```
npm i @leadsimple/material-ui-pickers @material-ui/core@latest

yarn add @leadsimple/material-ui-pickers @material-ui/core@latest
```
...
```diff
- import { InlineDatePicker } from '@leadsimple/material-ui-pickers'
+ import { DatePicker } from '@leadsimple/material-ui-pickers'
