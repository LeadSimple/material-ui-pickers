...
const Releases: NextFC<ReleasesProps> = ({ tags }) => {
  ...
  return (
    <>
      <PageMeta
        title="Releases - @leadsimple/material-ui-pickers"
        description="List of @leadsimple/material-ui-pickers releases with a link to per-release documentation site."
      />
