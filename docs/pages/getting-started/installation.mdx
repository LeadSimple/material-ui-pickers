...
<PageMeta
  title="Installation"
  description="Step-by-step guide how to install @leadsimple/material-ui-pickers"
/>

## Installation

Available as an [npm package](https://www.npmjs.com/package/@leadsimple/material-ui-pickers)
...
@leadsimple/material-ui-pickers was designed to use the date management library of your choice.
