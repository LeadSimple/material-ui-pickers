...
exports.DateTimePickerToolbar = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(PickerToolbar_1.default, { isLandscape: false, className: classes.toolbar },
            React.createElement(Grid_1.default, { container: true, justifyContent: "center", wrap: "nowrap" },
                React.createElement(Grid_1.default, { item: true, container: true, xs: 5, justifyContent: "flex-start", direction: "column" },
                ...
                React.createElement(Grid_1.default, { item: true, container: true, xs: 6, justifyContent: "center", alignItems: "flex-end", direction: rtl ? 'row-reverse' : 'row' },
                ...
                ampm && (React.createElement(Grid_1.default, { item: true, container: true, xs: 1, direction: "column", justifyContent: "flex-end" },
